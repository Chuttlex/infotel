...
public class RegleService {
	...
	public RegleService(RegleRepository regleRep,@Lazy EquipeService equipeService,@Lazy CompetenceService compService,@Lazy NiveauService niveauService) {
	...
	public void create(Regle regle) {
		regleRep.save(regle);
		Equipe equipe = regle.getEquipe();
		Competence comp = regle.getCompetence();
		Niveau n = regle.getNiveau();
