...
public class RessourceService {
	...
	public RessourceService(RessourceRepository resRep,@Lazy EquipeService equipeService, HistoriqueresService histService,
	...
	public void create(Ressource ressource) {
		Equipe equipe = ressource.getEquipe();
	...
	public Historiqueres getHistorique(String nom, String prenom, String equipe) {
		return histService.getByRessource(nom, prenom, equipe);
	}
	...
	public Ressource getByNomAndPrenomAndEquipe(String nom, String prenom, String enom) {
		Equipe e = equipeService.getByNom(enom);
		return this.resRep.findByNomAndPrenomAndEquipe(nom, prenom, e);
	}
	...
	public ArrayList<Ressource> getByNomAndPrenom(String nom, String prenom) {
