...
public class HistoriqueresService {
	...
	public HistoriqueresService(HistoriqueresRepository histRep,@Lazy RessourceService resService) {
	...
	public void create(Historiqueres hist) {
		Ressource res = hist.getRessource();
		histRep.save(hist);
	...
	public Historiqueres getByRessource(String nom,String prenom, String equipe)  {
