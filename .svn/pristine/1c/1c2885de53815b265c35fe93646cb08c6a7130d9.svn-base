...
public class RessourcehascompetenceService {
	...
	public RessourcehascompetenceService(RessourcehascompetenceRepository rcRep,@Lazy RessourceService resService,
			@Lazy CompetenceService compService,@Lazy NiveauService niveauService,@Lazy OrganismeService orgService) {
	...
	public List<Ressourcehascompetence> getByRessource(String nom, String prenom, String equipe)  {
		Ressource r = resService.getByNomAndPrenomAndEquipe(nom, prenom, equipe);
		if(r==null)
	...
	public List<Ressourcehascompetence> getByRessource(int id)  {
	...
	public List<Ressourcehascompetence> getByRessourceAndCompetence(String nom,String prenom,String equipe,String Cnom) {
		Ressource r = resService.getByNomAndPrenomAndEquipe(nom, prenom, equipe);
		if(r==null)
			return new ArrayList<>();
	...
	public List<Ressourcehascompetence> getByRessourceAndNiveau(String nom,String prenom,String equipe, int valeur,String orgNom) {
		Ressource r = resService.getByNomAndPrenomAndEquipe(nom, prenom, equipe);
		if(r==null)
			return new ArrayList<>();
	...
	public Ressourcehascompetence getByRessourceAndCompetenceAndNiveau(String nom,String prenom,String equipe,
			String Cnom,int valeur,String orgNom) {
		Ressource r = resService.getByNomAndPrenomAndEquipe(nom, prenom, equipe);
		if(r==null)
	...
	public List<Ressourcehascompetence> getByNiveauAndCompetence(int valeur,String orgnom, String nom) {
		Organisme org = orgService.getByNom(orgnom);
		if(org==null)
			return new ArrayList<>();
		Niveau n = org.getNiveaus().get(valeur);
		if(n==null)
	...
	public Ressource getRessourceByNomAndPrenomAndEquipe(String nom, String prenom, String equipe) {
		return resService.getByNomAndPrenomAndEquipe(nom, prenom, equipe);
	}
	...
	public List<Ressourcehascompetence> getByRessourceAndDateEvol(String nom,String prenom, String equipe,Date evol){
		Ressource r = resService.getByNomAndPrenomAndEquipe(nom,prenom,equipe);
		if(r==null)
			return new ArrayList<>();
		List<Ressourcehascompetence> rcs = new ArrayList<>();
	...
	public List<Ressourcehascompetence> getByRessourceAndCompetenceAndDateEvol(String nom,String prenom,String equipe,
			String cnom,Date evol){
		Ressource r = resService.getByNomAndPrenomAndEquipe(nom,prenom,equipe);
		if(r==null)
			return new ArrayList<>();
		Competence c = compService.getByNom(cnom);
